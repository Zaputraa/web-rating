	...
	<div  class="table table-bordered">
		<table>
			...
			<tbody>
				...
				$rating_total = mysqli_query($koneksi, "select * from rating where dosen='$nama'");
				$int_total = (int)mysqli_num_rows($rating_total);

				$query = mysqli_query($koneksi,"SELECT dosen from rating where dosen='$nama'");
				$query_1 = mysqli_query($koneksi,"SELECT count(*) as total from rating where dosen='$nama' and rate='1'");
				$query_2 = mysqli_query($koneksi,"SELECT count(*) as total from rating where dosen='$nama' and rate='2'");
				$query_3 = mysqli_query($koneksi,"SELECT count(*) as total from rating where dosen='$nama' and rate='3'");
				$query_4 = mysqli_query($koneksi,"SELECT count(*) as total from rating where dosen='$nama' and rate='4'");
				$query_5 = mysqli_query($koneksi,"SELECT count(*) as total from rating where dosen='$nama' and rate='5'");
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					data: [
					<?php 
					$satu = mysqli_query($koneksi,"select * from rating where rate='1' and dosen='$nama'");
					...
					?>,
					<?php 
					$dua = mysqli_query($koneksi,"select * from rating where rate='2' and dosen='$nama'");
					...
					?>, 
					<?php 
					$tiga = mysqli_query($koneksi,"select * from rating where rate='3' and dosen='$nama'");
					...
					?>, 
					<?php 
					$empat = mysqli_query($koneksi,"select * from rating where rate='4' and dosen='$nama'");
					...
					?>,
					<?php 
					$lima = mysqli_query($koneksi,"select * from rating where rate='5' and dosen='$nama'");
