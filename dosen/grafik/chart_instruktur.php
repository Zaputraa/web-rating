...
<body>
	...
	<table>
		...
		<tbody>
			<?php 
            $nama = $_GET['name'];
			$rating_total = mysqli_query($koneksi, "select * from rating where instruktur='$nama'");
			$int_total = (int)mysqli_num_rows($rating_total);
			
			$query = mysqli_query($koneksi,"SELECT instruktur from rating where instruktur='$nama'");
			$query_1 = mysqli_query($koneksi,"SELECT count(*) as total from rating where instruktur='$nama' and rate_ins='1'");
			$query_2 = mysqli_query($koneksi,"SELECT count(*) as total from rating where instruktur='$nama' and rate_ins='2'");
			$query_3 = mysqli_query($koneksi,"SELECT count(*) as total from rating where instruktur='$nama' and rate_ins='3'");
			$query_4 = mysqli_query($koneksi,"SELECT count(*) as total from rating where instruktur='$nama' and rate_ins='4'");
			$query_5 = mysqli_query($koneksi,"SELECT count(*) as total from rating where instruktur='$nama' and rate_ins='5'");
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					data: [
					<?php 
					$satu = mysqli_query($koneksi,"select * from rating where rate_ins='1' and instruktur='$nama'");
					...
					?>,
					<?php 
					$dua = mysqli_query($koneksi,"select * from rating where rate_ins='2' and instruktur='$nama'");
					...
					?>, 
					<?php 
					$tiga = mysqli_query($koneksi,"select * from rating where rate_ins='3' and instruktur='$nama'");
					...
					?>, 
					<?php 
					$empat = mysqli_query($koneksi,"select * from rating where rate_ins='4' and instruktur='$nama'");
					...
					?>,
					<?php 
					$lima = mysqli_query($koneksi,"select * from rating where rate_ins='5' and instruktur='$nama'");
