            ...
            <div class="container-fluid">
                ...
                <div class="table table-striped">
                    <table style="width:100%">
                        ...
                        $data = mysqli_query($koneksi,"select * from rating where matkul='$matkul'");
                        $jumlah_data = mysqli_num_rows($data);
                        $total_halaman = ceil($jumlah_data / $batas);

                        $data_rating = mysqli_query($koneksi,"select * from rating where matkul='$matkul' limit $halaman_awal, $batas");
