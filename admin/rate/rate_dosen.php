            ...
            <div class="container-fluid">
                ...
                <div class="table table-striped">
                    <table style="width:100%">
                        ...
                        $data = mysqli_query($koneksi,"select * from rating where dosen='$dosen'");
                        $jumlah_data = mysqli_num_rows($data);
                        $total_halaman = ceil($jumlah_data / $batas);

                        $data_rating = mysqli_query($koneksi,"select * from rating where dosen='$dosen' limit $halaman_awal, $batas");
