            ...
            <div class="container-fluid">
                ...
                <div class="table table-striped">
                    <table style="width:100%">
                        ...
                        $data = mysqli_query($koneksi,"select * from rating where asdos='$asdos' ORDER BY id ASC");
                        $jumlah_data = mysqli_num_rows($data);
                        $total_halaman = ceil($jumlah_data / $batas);

                        $data_rating = mysqli_query($koneksi,"select * from rating where asdos='$asdos' limit $halaman_awal, $batas");
                        $nomor = $halaman_awal + 1;
                        while($d = mysqli_fetch_array($data_rating)){
                            ?>
                            <tr>
                                ...
                                <td><?php echo $d['rate_asdos']; ?></td>
                                <td><?php echo $d['saran_asdos']; ?></td>
                            </tr>
                        <?php } ?>
                    </table>
