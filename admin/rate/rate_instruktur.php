            ...
            <div class="container-fluid">
                ...
                <div class="table table-striped">
                    <table style="width:100%">
                        ...
                        $data = mysqli_query($koneksi,"select * from rating where instruktur='$instruktur' ORDER BY tgl DESC");
                        $jumlah_data = mysqli_num_rows($data);
                        $total_halaman = ceil($jumlah_data / $batas);

                        $data_rating = mysqli_query($koneksi,"select * from rating where instruktur='$instruktur' limit $halaman_awal, $batas");
                        ...
                        while($d = mysqli_fetch_array($data_rating)){
                            ...
                            <tr>
                                ...
                                <td><?php echo $d['rate_ins']; ?></td>
                                <td><?php echo $d['saran_ins']; ?></td>
                            </tr>
                        <?php } ?>
                    </table>
