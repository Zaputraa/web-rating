...
<body>
	...
	<table border="1">
		...
		<tbody>
			...
			$no = 1;
			$data = mysqli_query($koneksi,"select * from rating where instruktur='$nama'");
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					data: [
					<?php 
					$satu = mysqli_query($koneksi,"select * from rating where rate='1' and instruktur='$nama'");
					...
					?>,
					<?php 
					$dua = mysqli_query($koneksi,"select * from rating where rate='2' and instruktur='$nama'");
					...
					?>, 
					<?php 
					$tiga = mysqli_query($koneksi,"select * from rating where rate='3' and instruktur='$nama'");
					...
					?>, 
					<?php 
					$empat = mysqli_query($koneksi,"select * from rating where rate='4' and instruktur='$nama'");
					...
					?>,
					<?php 
					$lima = mysqli_query($koneksi,"select * from rating where rate='5' and instruktur='$nama'");
