...
<body>
	...
	<table border="1">
		...
		<tbody>
			...
			$no = 1;
			$data = mysqli_query($koneksi,"select * from rating where asdos='$nama'");
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					data: [
					<?php 
					$satu = mysqli_query($koneksi,"select * from rating where rate='1' and asdos='$nama'");
					...
					?>,
					<?php 
					$dua = mysqli_query($koneksi,"select * from rating where rate='2' and asdos='$nama'");
					...
					?>, 
					<?php 
					$tiga = mysqli_query($koneksi,"select * from rating where rate='3' and asdos='$nama'");
					...
					?>, 
					<?php 
					$empat = mysqli_query($koneksi,"select * from rating where rate='4' and asdos='$nama'");
					...
					?>,
					<?php 
					$lima = mysqli_query($koneksi,"select * from rating where rate='5' and asdos='$nama'");
