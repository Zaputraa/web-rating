            ...
            <div class="container-fluid">
                ...
                if(isset($_POST['preview'])){
                    ...
                    foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
                        ...
                        <tr>
                        <td><?php echo $nik_td[$nik]; ?></td>
                        <td><?php echo $nama_td[$nama]; ?></td>
                        <td><?php echo $user_td[$username]; ?></td>
                        <td><?php echo $pass_td[$pass]; ?></td>
                        <td><?php echo $role_td[$role]; ?></td>
                    ...
                    <?php }else{ // Jika file yang diupload bukan File Excel 2007 (.xlsx)
